...
function GetDynamicPanelScript(dpId, numberStates) {
  var s =
    ...
    dpId +
    '(visibility) { document.getElementById("' +
    dpId +
    '").style.visibility = visibility;	if (visibility == "hidden") {';
  ...
  s =
    s + "} else { currentState" + dpId + ".style.visibility = visibility; } } ";

  s =
    s +
    "function SetPanelState" +
    dpId +
    "(stateid) {	SetPanelVisibility" +
    dpId +
    '("hidden");	document.getElementById("' +
    dpId +
    '").style.visibility = "";	currentState' +
    dpId +
    " = document.getElementById(stateid); currentState" +
    dpId +
    '.style.visibility = ""; }';
...
function ApplyImageAndTextStyles(preface, id, textid, json, bringToFront) {
  ...
  if (obj && obj.style.visibility == "hidden" && preface == "o") {
    return;
  }
  ...
  if (bringToFront) {
    BringToFront(preface + id);
    BringToFront(id + "container");
    BringToFront(id);
    BringToFront(id + "ann");
  }
}
